function comprobarPalabra(cad_arg){
    ...
    if (mayuscula & minuscula){
        document.write (cadena+"<br> Formado por mayusculas y minisculas");
    }else{
        if (mayuscula & !minuscula){
            document.write(cadena+"<br> Formado solo por mayusculas");
        }else{
            document.write(cadena+"<br> Formado solo por minusculas");
        }
    }
}
